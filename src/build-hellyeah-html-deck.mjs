...
const ASSET_SRC = path.join(PROJECT_ROOT, "src/assets");
const OUT_DIR = PROJECT_ROOT;
const ASSET_OUT = path.join(OUT_DIR, "assets");
const OUT = path.join(OUT_DIR, "index.html");
const previewOut = (slideNumber) =>
  path.join(OUT_DIR, `preview-slide-${String(slideNumber).padStart(2, "0")}.html`);
...
const assetFiles = [
  ...
  "web-logo-aonic-prnewswire-transparent.png",
  "web-logo-wpt.png",
  "web-logo-truist.svg",
  "web-logo-jt-express.svg",
  ...
  "web-logo-chai-official.svg",
  "web-logo-finalround.svg",
  "web-logo-finalround-black-white.svg",
  "web-logo-hyperspell-linkedin.png",
  "web-logo-hyperspell-webflow.png",
  "web-logo-hyperspell-webflow-cropped.png",
  "web-logo-mavia-google.png",
  "web-logo-dena-google.png",
  "web-logo-lords-mobile-google.png",
  "web-logo-lords-mobile-user.png",
  "web-logo-skrice-google.png",
  "web-logo-mocksi-google.png",
  "web-logo-the-dyrt-google.png",
  "web-logo-the-dyrt-icon.png",
  "web-logo-the-dyrt-user-wordmark.png",
  "web-logo-insforge-google.png",
  "web-logo-dopple-google.png",
  "web-logo-tea-ai-google.png",
  "web-logo-ace-studio-google.png",
  "web-logo-visko-google.png",
  "web-logo-cookiy-google.png",
  "web-logo-runner-ai-icon.png",
  "web-logo-polargrid-inverted.png",
  "web-logo-polargrid-icon.png",
  "web-logo-tavus-google.png",
  "web-logo-dolphin-browser-google.png",
  "web-logo-bear-ai-google.png",
  "web-logo-middleware-google.png",
  "web-logo-vipkid-google.png",
  "web-logo-spectra-capital-google.png",
  "web-logo-harmay-google.png",
  ...
  "asset-creative-gallery-mid.png",
  "asset-creative-gallery-video.png",
  "asset-creative-gallery-mid-aligned.png",
  "asset-creative-gallery-video-aligned.png",
  "asset-campaign-analytics-crop.png",
  ...
  "platform-tiktok.svg",
  "platform-snapchat-user-cropped.png",
  "platform-appstore-user.png",
  "hellyeah-geist-latin.woff2",
  "hellyeah-geist-mono-latin.woff2",
  "hellyeah-eb-garamond-italic-latin.woff2",
];

const logo = (file, alt, extra = "") =>
  `<img class="logo-img ${extra}" src="assets/${file}" alt="${alt}">`;
...
const splitTitle = (a, b) => `
  <div class="eyebrow ${a.className || ""}">${esc(a.eyebrow)}</div>
  <h1 class="${a.className || ""}"><span>${esc(a.titleA)}</span>${b ? ` <span class="accent">${esc(b)}</span>` : ""}</h1>
  ${a.sub ? `<p class="lead">${esc(a.sub)}</p>` : ""}
`;

const card = ({ value, title, body, dark = false, className = "", logoFile = "", logoName = "", logoClass = "" }) => `
  <div class="card ${dark ? "card-dark" : ""} ${className}">
    ${logoFile ? `<div class="case-logo ${dark ? "case-logo-plate" : ""} ${logoClass}">${logo(logoFile, `${logoName || title} logo`)}</div>` : ""}
    ${value ? `<div class="metric">${esc(value)}</div>` : ""}
    <h3>${esc(title)}</h3>
    <p>${esc(body)}</p>
  </div>
`;

const caseProof = ({ logoFile, logoName, logoClass = "", metric, metricLabel, result, story, sales, dark = false }) => `
  <article class="case-proof ${dark ? "case-proof-dark" : ""}">
    <div class="case-proof-head">
      <div>
        <div class="case-proof-name">${esc(logoName)}</div>
      </div>
      ${logoFile ? `<div class="case-proof-logo ${logoClass}">${logo(logoFile, `${logoName} logo`)}</div>` : ""}
    </div>
    <div class="case-result">
      <div class="case-metric">${esc(metric)}</div>
      <div>
        <div class="case-metric-label">${esc(metricLabel)}</div>
        <div class="case-result-line">${esc(result)}</div>
      </div>
    </div>
    <p class="case-story">${esc(story)}</p>
    <div class="case-sales">${esc(sales)}</div>
  </article>
`;

const customerCase = ({ logoFile, logoName, logoClass = "", category, summary, story, metrics, tags = [], dark = false }) => `
  <article class="customer-case ${dark ? "customer-case-dark" : ""}">
    <div class="customer-case-head">
      <div>
        <div class="customer-category">${esc(category)}</div>
        <div class="customer-name">${esc(logoName)}</div>
      </div>
      ${logoFile ? `<div class="customer-logo ${logoClass}">${logo(logoFile, `${logoName} logo`)}</div>` : ""}
    </div>
    <p class="customer-summary">${esc(summary)}</p>
    <div class="customer-classic-story">
      <b>Classic story</b>
      <span>${esc(story)}</span>
    </div>
    <div class="customer-metrics metrics-${metrics.length}">
      ${metrics.map((item) => `
...
const appendixMetrics = (metrics, className = "") => `
  <div class="appendix-metrics ${className} count-${metrics.length}">
    ${metrics.map((item) => `
      <div>
        <b>${esc(item.value)}</b>
        <span>${esc(item.label)}</span>
...
const appendixTags = (tags) => `
  <div class="appendix-tags">${tags.map((tag) => `<span>${esc(tag)}</span>`).join("")}</div>
`;

const appendixMainCase = ({ logoFile, logoName, logoClass = "", category, title, metric, metricLabel, blocks, metrics = [] }) => `
  <article class="appendix-main-case">
    <div class="appendix-case-head">
      <div>
        <div class="appendix-case-category">${esc(category)}</div>
        <h2>${esc(logoName)}</h2>
      </div>
      ${logoFile ? `<div class="appendix-case-logo ${logoClass}">${logo(logoFile, `${logoName} logo`)}</div>` : ""}
    </div>
    <div class="appendix-main-body">
      <div class="appendix-main-metric">
        <p>${esc(title)}</p>
        <b>${esc(metric)}</b>
        <span>${esc(metricLabel)}</span>
      </div>
      <div class="appendix-main-blocks">
        ${blocks.map((block) => `
          <section>
    ...
    ${metrics.length ? appendixMetrics(metrics, "main-extra") : ""}
  </article>
`;

const appendixSideCase = ({ logoFile, logoName, logoClass = "", category, summary, metrics, tags }) => `
  <article class="appendix-side-case">
    <div class="appendix-side-head">
      <div>
        <div class="appendix-case-category">${esc(category)}</div>
        <h3>${esc(logoName)}</h3>
      </div>
      ${logoFile ? `<div class="appendix-side-logo ${logoClass}">${logo(logoFile, `${logoName} logo`)}</div>` : ""}
    </div>
    <p>${esc(summary)}</p>
    ${appendixMetrics(metrics, "side")}
    ${appendixTags(tags)}
  </article>
`;

const appendixOverviewCase = ({ logoFile, logoName, logoClass = "", category, title, metrics, blocks, tags, logoOnly = false }) => `
  <article class="appendix-overview-case">
    <div class="appendix-case-head ${logoOnly ? "appendix-logo-only-head" : ""}">
      ${logoOnly ? `
        <div class="appendix-case-category">${esc(category)}</div>
      ` : `
        <div>
    ...
    <p class="appendix-overview-title">${esc(title)}</p>
    ${appendixMetrics(metrics)}
    <div class="appendix-overview-blocks">
      ${blocks.map((block) => `
        <section>
          <small>${esc(block.label)}</small>
          <h3>${esc(block.title)}</h3>
...
const appendixCompactCase = ({ logoFile, logoName, logoClass = "", category, summary, metrics, tags, boundary }) => `
  <article class="appendix-compact-case">
    <div class="appendix-side-head">
      <div>
        <div class="appendix-case-category">${esc(category)}</div>
        <h3>${esc(logoName)}</h3>
    ...
    <p>${esc(summary)}</p>
    ${appendixMetrics(metrics, "compact")}
    ${appendixTags(tags)}
    ${boundary ? `<div class="appendix-boundary">${esc(boundary)}</div>` : ""}
  </article>
`;

const operatorCase = ({ brand, logoFile = "", logoClass = "", category, title, sub, beats, metrics, tags, proofNote }) => `
  <div class="operator-case-layout">
    <section class="operator-story">
      <div class="operator-case-head">
        <div>
          <div class="operator-category">${esc(category)}</div>
          <h2>${esc(title)}</h2>
          <p>${esc(sub)}</p>
        </div>
        ${logoFile ? `<div class="operator-logo ${logoClass}">${logo(logoFile, `${brand} logo`)}</div>` : `<div class="operator-wordmark">${esc(brand)}</div>`}
      </div>
      <div class="operator-beats">
        ${beats.map((beat, index) => `
          <article class="operator-beat">
            <div class="operator-node">${String(index + 1).padStart(2, "0")}</div>
            <div>
              <small>${esc(beat.label)}</small>
    ...
    <aside class="operator-proof">
      <div class="operator-proof-label">Operator proof</div>
      <div class="operator-proof-metrics">
        ${metrics.map((item, index) => `
          <div class="operator-proof-metric ${index === 0 ? "hero" : ""}">
            <b>${esc(item.value)}</b>
            <span>${esc(item.label)}</span>
          </div>
        `).join("")}
      </div>
      <div class="operator-tags">${tags.map((tag) => `<span>${esc(tag)}</span>`).join("")}</div>
      ${proofNote ? `<p class="operator-proof-note">${esc(proofNote)}</p>` : ""}
    </aside>
  </div>
`;

const proposalRow = (decision, test, scale) => `
  <tr>
    <th>${esc(decision)}</th>
    <td>${esc(test)}</td>
    <td>${esc(scale)}</td>
...
const footer = (dark = false) => `<footer class="slide-footer ${dark ? "footer-dark" : ""}">Revenue-first user acquisition</footer>`;

const slide = (num, section, body, theme = "light", includeFooter = true, pageLabel) => `
  <section id="slide-${String(num).padStart(2, "0")}" class="slide ${theme}">
    ${header(num, section, theme === "dark" || theme === "orange", pageLabel)}
    ${body}
    ${includeFooter ? footer(theme === "dark" || theme === "orange") : ""}
  </section>
`;

const logoTile = ({ name, file, dark = false, wide = false, icon = false, tall = false, className = "" }) => `
  <div class="client-slot">
    <div class="client-logo ${dark ? "client-dark" : ""} ${wide ? "logo-wide" : ""} ${icon ? "logo-icon" : ""} ${tall ? "logo-tall" : ""} ${className}">
      ${logo(file, `${name} logo`)}
    </div>
  </div>
`;

const wallLogo = ({ name, file = "", className = "", wordmark = false }) => `
  <div class="logo-wall-cell ${className} ${wordmark ? "logo-with-name" : ""}">
    ${file ? logo(file, `${name} logo`) : ""}
    ${wordmark || !file ? `<span class="logo-wordmark">${esc(name)}</span>` : ""}
  </div>
`;

const variantCells = (count, hotEvery = 0) =>
  Array.from({ length: count }, (_, index) => `<span class="${hotEvery && index % hotEvery === 0 ? "hot" : ""}"></span>`).join("");

const css = `
@font-face {
  font-family: "Hellyeah Geist";
  src: url("assets/hellyeah-geist-latin.woff2") format("woff2");
  font-weight: 100 900;
  font-style: normal;
  font-display: swap;
}
@font-face {
  font-family: "Hellyeah Garamond";
  src: url("assets/hellyeah-eb-garamond-italic-latin.woff2") format("woff2");
  font-weight: 400 700;
  font-style: italic;
  font-display: swap;
}
...
:root {
  ...
  --paper: #f5f5f5;
  --paper-2: #e5e5e5;
  --font-sans: "Hellyeah Geist", Geist, "Helvetica Neue", Arial, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif;
  --font-serif: "Hellyeah Garamond", "EB Garamond", Georgia, serif;
}
...
.slide::before {
  ...
  pointer-events: none;
  background:
    linear-gradient(90deg, rgba(255, 67, 1, 0.9) 0 6px, transparent 6px) 0 0 / 100% 100% no-repeat;
  opacity: 1;
}
...
.slide.orange {
  background:
    radial-gradient(circle at 82% 18%, rgba(255, 67, 1, 0.16), transparent 28%),
...
.slide.dark::before {
  background:
    linear-gradient(90deg, rgba(255, 67, 1, 0.95) 0 6px, transparent 6px) 0 0 / 100% 100% no-repeat;
}
...
.brand { width: 152px; height: auto; display: block; }
.page-label {
  font-family: var(--font-sans);
  font-size: 10.5px;
  line-height: 1;
...
.dark .page-label { color: var(--soft); }
.orange .page-label { color: var(--soft); }

.slide-footer {
  display: none;
}
.footer-dark { color: #737373; }
...
.dark h1 span:not(.accent) { color: var(--white); }
h1.one-line-title {
  max-width: none;
  white-space: nowrap;
  font-size: 39px;
...
.creative-layout .metric-pair,
.proof-compact-layout .metric-pair {
  max-width: none;
  margin-top: 0;
}
.creative-copy {
...
.slide:not(.dark):not(.orange) .card-dark {
...
.case-logo-fish .logo-img { filter: none; }
.case-logo-eragon { width: 118px; height: 34px; }
.case-logo-befreed { width: 132px; height: 32px; }
.case-logo-viggle { width: 42px; height: 42px; top: 18px; right: 22px; }
.case-logo-jt { width: 86px; height: 34px; }
.case-proof-grid {
  display: grid;
  grid-template-columns: repeat(2, 1fr);
  gap: 18px;
...
.case-proof-dark .case-proof-name { color: var(--white); }
.case-proof-logo {
  width: 112px;
  height: 34px;
  display: flex;
...
.case-proof-logo.case-logo-viggle {
  width: 42px;
  height: 42px;
  margin-top: -3px;
}
.case-proof-logo.case-logo-befreed {
  width: 122px;
  height: 30px;
}
.case-result {
...
.case-proof-dark .case-metric-label { color: var(--white); }
.case-result-line {
  margin-top: 4px;
  color: var(--text);
  font-size: 12px;
...
.case-proof-dark .case-result-line { color: #d4d4d4; }
.case-story {
  margin: 0;
  color: var(--text);
  font-size: 13.2px;
...
.case-proof-dark .case-story { color: #d4d4d4; }
.case-sales {
  margin-top: auto;
  padding-top: 14px;
...
.customer-case-grid.two-by-two .customer-case {
  min-height: 220px;
...
.customer-case-dark .customer-category { color: #737373; }
.customer-name {
  margin-top: 7px;
  color: var(--black);
  font-size: 21px;
...
.customer-case-dark .customer-name { color: var(--white); }
.customer-logo {
  width: 116px;
  height: 32px;
  display: flex;
...
.customer-logo.case-logo-befreed { width: 118px; height: 28px; }
.customer-logo.case-logo-viggle { width: 38px; height: 38px; }
...
.customer-case-grid.four-up .customer-name {
  font-size: 18px;
}
.customer-case-grid.four-up .customer-logo {
  width: 84px;
  height: 28px;
}
.customer-case-grid.four-up .customer-logo.case-logo-fish { width: 40px; height: 40px; }
.customer-case-grid.four-up .customer-logo.case-logo-eragon { width: 88px; height: 26px; }
.customer-case-grid.four-up .customer-logo.case-logo-viggle { width: 34px; height: 34px; }
.customer-summary {
  margin: 0 0 11px;
  color: var(--text);
  font-size: 12.6px;
...
.customer-case-grid.two-by-two .customer-summary {
  min-height: 0;
  margin-bottom: 6px;
  font-size: 11.2px;
  line-height: 1.12;
...
.customer-classic-story span {
  color: var(--text);
  font-size: 10.5px;
  line-height: 1.12;
  font-weight: 700;
}
.customer-case-dark .customer-classic-story span { color: #d4d4d4; }
.customer-case-grid.two-by-two .customer-classic-story {
  grid-template-columns: 78px 1fr;
  gap: 7px;
  margin-bottom: 8px;
}
.customer-case-grid.two-by-two .customer-classic-story b {
  font-size: 7.2px;
}
.customer-case-grid.two-by-two .customer-classic-story span {
  font-size: 9px;
  line-height: 1.08;
}
...
.customer-metrics.metrics-2 {
  grid-template-columns: repeat(2, minmax(0, 150px));
  justify-content: start;
  column-gap: 24px;
}
.customer-case-dark .customer-metrics { border-top-color: rgba(255, 255, 255, 0.12); }
.customer-metric b {
  display: block;
  color: var(--orange);
  font-size: 28px;
...
.customer-case-grid.two-by-two .customer-metric b { font-size: 24px; }
.customer-metrics.metrics-2 .customer-metric b { font-size: 30px; }
.customer-case-grid.two-by-two .customer-metrics.metrics-2 .customer-metric b { font-size: 25px; }
.customer-case-grid.two-by-two .customer-metrics {
  padding-top: 9px;
}
.customer-case-grid.two-by-two .customer-metric span {
  font-size: 8.4px;
}
...
.customer-case-dark .customer-metric span { color: #d4d4d4; }
.customer-tags {
  display: flex;
  gap: 6px;
  flex-wrap: wrap;
...
.customer-case-dark .customer-tags span {
  border-color: rgba(255, 255, 255, 0.14);
  color: #d4d4d4;
  background: rgba(255, 255, 255, 0.05);
}
.customer-case-grid.two-by-two .customer-tags {
  margin-top: 8px;
}
.customer-case-grid.two-by-two .customer-tags span {
  padding: 4px 6px 3px;
  font-size: 7.6px;
}
...
.appendix-case-head h2,
.appendix-side-head h3 {
  margin: 7px 0 0;
  color: var(--black);
  line-height: 1;
  letter-spacing: 0;
...
.appendix-case-logo .logo-img,
.appendix-side-logo .logo-img {
  width: auto;
  height: auto;
  max-width: 100%;
  max-height: 100%;
...
.appendix-side-logo.case-logo-viggle { width: 35px; height: 35px; }
.appendix-side-logo.case-logo-jt { width: 76px; height: 28px; }
.appendix-side-logo.case-logo-fish { width: 42px; height: 42px; }
.appendix-side-logo.case-logo-aonic { width: 92px; height: 30px; }
.appendix-side-logo.case-logo-harmay { width: 92px; height: 28px; }
.appendix-case-logo.case-logo-fish { width: 78px; height: 44px; overflow: visible; }
.appendix-case-logo.case-logo-fish .logo-img { max-width: none; max-height: none; width: 70px; height: 70px; }
.appendix-main-body {
  display: grid;
  grid-template-columns: minmax(0, 0.74fr) minmax(0, 1.26fr);
  gap: 16px;
}
.appendix-main-metric {
  min-height: 172px;
  padding: 20px 18px;
  border: 1px solid rgba(0, 0, 0, 0.1);
...
.appendix-main-blocks,
.appendix-overview-blocks {
  display: grid;
  gap: 14px;
}
.appendix-main-blocks {
...
.appendix-main-blocks section,
.appendix-overview-blocks section {
  padding: 14px;
  border: 1px solid rgba(0, 0, 0, 0.1);
  background: rgba(255, 255, 255, 0.42);
}
.appendix-main-blocks small,
.appendix-overview-blocks small {
  display: block;
  margin-bottom: 10px;
  color: var(--orange);
  font-family: var(--font-sans);
...
.appendix-main-blocks h3,
.appendix-overview-blocks h3 {
  margin: 0 0 9px;
  color: var(--black);
  font-size: 20px;
  line-height: 1.1;
...
.appendix-main-blocks p,
.appendix-overview-blocks p,
.appendix-side-case > p,
.appendix-compact-case > p,
.appendix-overview-title {
  margin: 0;
  color: var(--text);
  font-size: 11.7px;
  line-height: 1.28;
...
.appendix-a1-layout .appendix-main-blocks h3 {
  font-size: 17px;
  line-height: 1.04;
}
.appendix-a1-layout .appendix-main-blocks p {
  font-size: 10.8px;
  line-height: 1.22;
}
.appendix-side-case > p {
...
.appendix-a1-layout .appendix-main-case {
  display: flex;
  flex-direction: column;
}
.appendix-a1-layout .appendix-main-body {
  flex: 1;
}
.appendix-a1-layout .appendix-side-case {
  display: flex;
  flex-direction: column;
  min-height: 0;
  padding: 15px 18px 14px;
}
.appendix-a1-layout .appendix-side-head {
  min-height: 34px;
  margin-bottom: 8px;
}
.appendix-a1-layout .appendix-side-head h3 {
  font-size: 17px;
}
.appendix-a1-layout .appendix-side-case > p {
  min-height: 0;
  white-space: nowrap;
  overflow: hidden;
...
.appendix-metrics.side b,
.appendix-metrics.compact b {
  font-size: 25px;
}
.appendix-a1-layout .appendix-metrics.side {
  margin-top: 12px;
  padding-top: 12px;
}
.appendix-a1-layout .appendix-metrics.side b {
  font-size: 27px;
}
.appendix-a1-layout .appendix-metrics.side span {
  font-size: 8.4px;
}
.appendix-metrics.main-extra {
  grid-template-columns: repeat(2, minmax(0, 1fr));
  margin-top: 12px;
}
.appendix-metrics.main-extra b {
  font-size: 30px;
}
.appendix-metrics.compact {
  gap: 8px;
  min-height: 62px;
  align-items: start;
  margin-top: 12px;
...
.appendix-a3-layout .appendix-tags {
  margin-top: auto;
  padding-top: 14px;
}
.appendix-a3-layout .appendix-boundary {
  display: none;
}
...
.appendix-a3-layout .appendix-case-head {
  min-height: 60px;
  margin-bottom: 10px;
...
.appendix-a3-layout .appendix-logo-only-head {
  min-height: 58px;
  margin-bottom: 12px;
  flex-direction: column;
...
.appendix-a3-layout .appendix-case-head h2 {
  margin-top: 6px;
  font-size: 20px;
}
.appendix-a3-layout .appendix-case-logo {
  width: 118px;
  height: 34px;
  justify-content: flex-start;
}
.appendix-a3-layout .appendix-case-logo.case-logo-jt {
  width: 118px;
  height: 34px;
}
.appendix-a3-layout .appendix-case-logo.case-logo-harmay {
  width: 118px;
  height: 34px;
}
.appendix-a3-layout .appendix-case-logo.case-logo-dyrt {
  width: 124px;
  height: 36px;
}
.appendix-a3-layout .appendix-case-logo.case-logo-truist {
  width: 116px;
  height: 34px;
}
...
.appendix-a3-layout .appendix-metrics.count-3 {
  grid-template-columns: auto auto auto;
  justify-content: space-between;
  column-gap: 12px;
}
.appendix-a3-layout .appendix-metrics b {
  font-size: 25px;
}
.appendix-a3-layout .appendix-metrics span {
  margin-top: 5px;
  font-size: 7.5px;
  line-height: 1.16;
}
...
.appendix-a1-layout .appendix-tags {
  margin-top: auto;
  padding-top: 12px;
}
.appendix-boundary {
...
.operator-logo.operator-logo-marvel {
  width: 150px;
  height: 54px;
}
.operator-wordmark {
...
.operator-proof {
  ...
  border-radius: 4px;
  background:
    radial-gradient(circle at 82% 12%, rgba(255, 67, 1, 0.22), transparent 32%),
    var(--black);
  color: var(--white);
  display: flex;
  flex-direction: column;
}
.operator-proof-label {
  color: var(--orange);
  font-size: 9px;
  line-height: 1;
  letter-spacing: 0.18em;
...
.operator-proof-metric {
  padding-top: 12px;
  border-top: 1px solid rgba(255, 255, 255, 0.16);
}
.operator-proof-metric:first-child {
  border-top: 0;
  padding-top: 0;
}
.operator-proof-metric b {
  display: block;
  color: var(--white);
  font-size: 29px;
  line-height: 0.95;
...
.operator-proof-metric.hero b {
  color: var(--orange);
  font-size: 58px;
}
.operator-proof-metric span {
  display: block;
  margin-top: 6px;
  color: #d4d4d4;
  font-size: 9.4px;
...
.operator-tags span {
  ...
  border: 1px solid rgba(255, 67, 1, 0.38);
  border-radius: 999px;
...
.proposal-table td:last-child { border-right: 0; }
.proposal-side {
  display: grid;
  gap: 12px;
}
...
.proposal-side .proposal-box:first-child {
  display: flex;
  flex-direction: column;
  justify-content: flex-start;
}
...
.slide.orange .diagnostic-board {
  grid-template-columns: minmax(0, 1fr) 344px;
  gap: 18px;
  margin-top: 36px;
}
.slide.orange .diagnostic-steps {
  grid-template-columns: repeat(3, 1fr);
  gap: 0;
  border-top: 1px solid rgba(255, 255, 255, 0.14);
  border-bottom: 1px solid rgba(255, 255, 255, 0.14);
}
.slide.orange .diagnostic-step {
  display: block;
  min-height: 268px;
...
.slide.orange .diagnostic-step:last-child { border-right: 0; }
.slide.orange .diagnostic-step b {
  display: block;
  color: var(--orange);
  font-size: 46px;
  line-height: 0.9;
...
.slide.orange .diagnostic-step h3 {
  font-size: 22px;
  margin-bottom: 10px;
}
.slide.orange .diagnostic-step p {
  font-size: 12.8px;
  line-height: 1.2;
}
.slide.orange .close-panel {
  min-height: 268px;
  padding: 30px 28px 26px;
}
.slide.orange .close-panel h2 {
  font-size: 38px;
  line-height: 0.96;
}
.slide.orange .close-panel p {
  max-width: 280px;
  font-size: 14px;
  line-height: 1.22;
}
...
.hero-visual {
  ...
  border-radius: 4px;
  background:
    radial-gradient(circle at 50% 50%, rgba(255, 67, 1, 0.13), transparent 58%),
    #0a0a0a;
...
.hero-visual-inner {
  ...
  display: grid;
  place-items: center;
  box-shadow: 0 24px 90px rgba(255, 67, 1, 0.38);
}
.hero-visual img { width: 82px; filter: brightness(0) invert(1); }
.cover-cred-panel {
  align-self: stretch;
  display: flex;
  flex-direction: column;
...
.client-grid-five .client-logo {
  padding: 0 4px;
}
.client-grid-five .client-logo img {
  max-width: 108px;
}
.client-grid-five .client-slot {
  grid-column: span 2;
}
.client-grid-five .client-slot:nth-child(4) {
  grid-column: 2 / span 2;
}
.client-grid-five .client-slot:nth-child(5) {
...
.logo-wide img { max-width: 72%; }
.logo-pokemon img { max-width: 128px; }
.logo-second img {
  max-width: 120px;
  max-height: 50px;
}
.logo-aonic img { max-width: 124px; }
.logo-tall img { max-height: 44px; }
.logo-viggle img {
  width: 54px;
  max-width: 54px;
  max-height: 54px;
...
.logo-wall-cell img {
  display: block;
  width: auto;
  height: var(--logo-wall-mark);
  max-width: 124px;
  max-height: var(--logo-wall-mark);
  object-fit: contain;
}
...
.divider { width: 1px; height: 260px; background: #2a2a2a; }
.compare-cards {
  display: grid;
...
.vs { color: var(--orange); font-size: 18px; font-weight: 800; text-align: center; }
...
.difference-grid {
  display: grid;
  grid-template-columns: 1.42fr repeat(3, 1fr);
  gap: 0;
  margin-top: 42px;
...
.difference-card.primary {
  background:
    linear-gradient(135deg, rgba(255, 67, 1, 0.16), transparent 46%),
    var(--black);
  color: var(--white);
}
.difference-card b {
...
.outcome-proof-card.featured small {
...
.outcome-case-logo .logo-img {
  display: block;
  width: 100%;
  height: 100%;
  object-fit: contain;
}
.outcome-case-logo.logo-playco {
  width: 40px;
  height: 36px;
}
...
.outcome-case-logo.logo-finalround .logo-img {
  filter: none;
}
...
.outcome-proof-card.featured .outcome-intervention {
...
.outcome-proof-card.featured .outcome-supporting strong {
  color: var(--black);
}
.outcome-supporting span {
  display: block;
  margin-top: 4px;
  color: #a1a1a1;
  font-size: 7.2px;
...
.outcome-proof-card.featured .outcome-supporting span {
...
.system-rail {
  ...
  background:
    linear-gradient(180deg, rgba(255, 67, 1, 0.08), transparent 48%),
...
.system-console {
  padding: 22px;
  background:
    radial-gradient(circle at 78% 24%, rgba(255, 67, 1, 0.16), transparent 26%),
    #0a0a0a;
...
.system-action b { color: var(--white); }
.system-action span { color: #a1a1a1; }
.system-action.strong b { color: var(--white); }
.system-action.strong span { color: #ffffff; }
.system-path {
  display: grid;
...
.variant-dots.ai span {
  background: rgba(255, 67, 1, 0.24);
}
.variant-dots span.hot {
  background: var(--orange);
}
.variant-panel.ai-panel {
  background:
    radial-gradient(circle at 72% 20%, rgba(255, 67, 1, 0.18), transparent 28%),
    var(--black);
  border-color: rgba(255, 255, 255, 0.16);
}
.variant-panel.ai-panel h2 { color: var(--white); }
.variant-panel.ai-panel p { color: #d4d4d4; }
...
.arch-node.dark {
  background:
    radial-gradient(circle at 78% 16%, rgba(255, 67, 1, 0.16), transparent 28%),
    var(--black);
  border-color: rgba(255, 255, 255, 0.16);
}
.arch-node.warm,
...
.product-promise-panel {
  padding: 22px 22px 20px;
  border-radius: 4px;
  background:
    radial-gradient(circle at 84% 14%, rgba(255, 67, 1, 0.16), transparent 34%),
    #0a0a0a;
  color: var(--white);
  border: 1px solid rgba(255, 67, 1, 0.18);
  display: flex;
...
.product-promise-panel small,
.product-capability-kicker {
  color: var(--orange);
  font-family: var(--font-sans);
  font-size: 9.4px;
  line-height: 1;
...
.product-capability-card:nth-child(4) {
  background: var(--black);
  color: var(--white);
}
...
.product-capability-card:nth-child(4) h2 {
  color: var(--white);
}
...
.product-capability-card:nth-child(4) p {
  color: #d4d4d4;
}
.product-pain {
  margin: 0 0 9px;
...
.product-capability-card:nth-child(4) .product-pain {
  color: #a1a1a1;
}
.product-proof-line {
  margin-top: auto;
...
.creative-volume-contrast > div:last-child {
  background: rgba(255,255,255,0.06);
  border-color: rgba(255,255,255,0.11);
}
.creative-volume-contrast > div:nth-child(2) {
  background:
    radial-gradient(circle at 78% 16%, rgba(255, 67, 1, 0.16), transparent 32%),
    rgba(255, 67, 1, 0.16);
  border-color: rgba(255, 67, 1, 0.28);
}
.creative-volume-contrast small {
  display: block;
  color: #a1a1a1;
  font-family: var(--font-sans);
  font-size: 8px;
...
.optimizer-queue {
  ...
  border-radius: 4px;
  background:
    radial-gradient(circle at 80% 14%, rgba(255, 67, 1, 0.12), transparent 28%),
    var(--black);
  color: var(--white);
  border: 1px solid rgba(255, 67, 1, 0.16);
}
...
.platform-card {
  ...
  border-top: 5px solid var(--channel);
  border-radius: 4px;
  display: flex;
  flex-direction: column;
}
...
.optimization-strip div:last-child { border-right: 0; }
.optimization-strip b {
  display: block;
  color: var(--orange);
  font-size: 11px;
  line-height: 1;
...
.operator-approval-note {
  ...
  border-radius: 4px;
  background:
    radial-gradient(circle at 88% 18%, rgba(255, 67, 1, 0.12), transparent 30%),
    var(--black);
  color: var(--white);
  border: 1px solid rgba(255, 67, 1, 0.16);
}
.operator-approval-note b {
  color: var(--orange);
  font-family: var(--font-sans);
  font-size: 10px;
  line-height: 1;
...
.proof-card.dark-proof {
  background:
    linear-gradient(180deg, rgba(255, 67, 1, 0.12), transparent 48%),
    var(--black);
  color: var(--white);
...
.proof-card.dark-proof .proof-label { color: var(--orange); }
.proof-logos {
  height: 38px;
  display: flex;
  align-items: center;
...
.proof-card.dark-proof .proof-metric { color: var(--orange); }
.proof-card p {
  margin: 14px 0 0;
  color: var(--text);
  font-size: 12.7px;
...
.proof-card.dark-proof p { color: #d4d4d4; }
.proof-card small {
  margin-top: auto;
  padding-top: 14px;
  color: var(--muted);
...
.proof-card.dark-proof small { color: #a1a1a1; }
...
.scale-gate-row:last-child { border-bottom: 0; }
.scale-gate-row:nth-child(2) {
...
.access-core {
  ...
  border-radius: 4px;
  background:
    radial-gradient(circle at 78% 18%, rgba(255, 67, 1, 0.14), transparent 28%),
    var(--black);
  color: var(--white);
  border: 1px solid rgba(255, 67, 1, 0.16);
  display: flex;
...
.access-core .access-line {
  margin-top: auto;
  min-height: 44px;
  display: flex;
  align-items: center;
  border-top: 1px solid rgba(255, 67, 1, 0.18);
  border-bottom: 1px solid rgba(255, 67, 1, 0.18);
  color: var(--orange);
  font-size: 10px;
  line-height: 1;
  letter-spacing: 0.12em;
...
.governance-core {
  ...
  border-radius: 4px;
  background:
    radial-gradient(circle at 76% 18%, rgba(255, 67, 1, 0.18), transparent 30%),
    var(--black);
  color: var(--white);
  border: 1px solid rgba(255, 67, 1, 0.16);
}
...
.governance-core .governance-rule {
  margin-top: 24px;
  padding-top: 18px;
  border-top: 1px solid rgba(255, 67, 1, 0.18);
  color: var(--orange);
...
.governance-row {
  display: grid;
  grid-template-columns: 0.82fr 1.18fr 0.78fr;
  min-height: 78px;
  border-bottom: 1px solid rgba(0, 0, 0, 0.16);
}
.governance-row > div {
...
.governance-row > div:last-child { border-right: 0; }
.governance-row.header > div {
  min-height: 38px;
...
.timeline > .card { align-self: start; }
.timeline .card {
  min-height: 104px;
  padding: 20px 20px 18px;
}
...
.cadence-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 18px; }
.mini-stats {
  display: grid;
  grid-template-columns: repeat(4, 1fr);
  gap: 18px;
...
.mini-stat b { color: var(--orange); font-size: 20px; line-height: 1; }
.mini-stat span { color: #d4d4d4; font-size: 8.8px; font-weight: 800; }
...
.dark .main-note strong,
.orange .main-note strong {
  color: var(--white);
}
.footnote {
  position: relative;
...
slides.push(slide(6, "Creative", `
  <main class="content">
    ...
    <div class="creative-proof-board">
      <aside class="creative-stats-panel">
        <div class="creative-volume-contrast">
          <div><small>manual agency cycle</small><b>5-10</b><span>concepts per review cycle</span><em>Traditional teams bottleneck on production and approval.</em></div>
          <div><small>one Hellyeah campaign queue</small><b>41</b><span>variants in review</span><em>Scripts, hooks, statics, and videos enter the queue before fatigue stalls learning.</em></div>
          <div><small>published mobile case</small><b>5.7x</b><span>creative throughput</span><em>Playco proof: faster learning surface, then CPI follows.</em></div>
        </div>
      </aside>
      <figure class="creative-shot-frame creative-gallery-frame">
        <div class="creative-gallery-split">
          <img src="assets/asset-creative-gallery-mid-aligned.png" alt="Creative gallery screenshot with multiple static variants">
          <img src="assets/asset-creative-gallery-video-aligned.png" alt="Creative gallery screenshot with video and image variants">
        </div>
      </figure>
    </div>
  </main>
...
slides.push(slide(13, "Appendix", `
  <main class="content">
    ...
    ${operatorCase({
      brand: "Marvel Snap",
      logoFile: "web-logo-marvel-snap.png",
      logoClass: "operator-logo-marvel",
      category: "Mobile gaming & entertainment",
      title: "Built to last for years, not spike for a week.",
      sub: "The case supports Hellyeah's mobile gaming credibility: launch strategy, monetization judgment, creative testing, and gated scale.",
      beats: [
        {
          label: "Challenge",
          title: "A make-or-break launch with monetization risk",
          body: "ByteDance backed the bid to win the go-to-market partnership with Second Dinner, the Marvel licensee. The launch monetization was too aggressive and risked backlash before the franchise could compound."
        },
        {
          label: "Move",
          title: "Rebuilt around trust, then scaled on proof",
          body: "The model was rolled back to hybrid subscription plus bundles, then launched through pre-launch testing, soft launch, and global scale."
        },
        {
          label: "Result",
          title: "The launch kept compounding",
          body: "The title cleared its two-year revenue goal and continued earning years after launch, long after most mobile titles fade."
        }
      ],
      metrics: [
        { value: "$2B+", label: "two-year revenue goal exceeded" },
        { value: "~$50M/mo", label: "peak monthly launch scale" },
        { value: "Top 1%", label: "titles by sustained revenue" },
        { value: "Still live", label: "earning years later" }
      ],
      tags: ["Mobile gaming", "Launch", "Monetization", "Gated scale"],
...
<body>
  <nav class="deck-actions" aria-label="Deck actions">
    <button type="button" data-print-deck>Print / Save PDF</button>
    <button type="button" data-download-deck>Download HTML</button>
  </nav>
  <main class="deck">
    ${slides.join("\n")}
  </main>
  <script>
    (() => {
      ...
      const downloadButton = document.querySelector("[data-download-deck]");
      ...
      downloadButton?.addEventListener("click", () => {
        ...
        doc.querySelectorAll(".deck-actions").forEach((node) => node.remove());
        doc.querySelectorAll("img[src]").forEach((img) => {
          const current = img.getAttribute("src");
          if (current) img.setAttribute("src", new URL(current, window.location.href).href);
        });
        ...
        anchor.href = url;
        anchor.download = "hellyeah-intro-deck.html";
...
await Promise.all(assetFiles.map((file) => fs.copyFile(path.join(ASSET_SRC, file), path.join(ASSET_OUT, file))));
await fs.writeFile(OUT, html, "utf8");
await Promise.all(Array.from({ length: slides.length }, (_, index) => index + 1).map((slideNumber) => fs.writeFile(
  previewOut(slideNumber),
  html.replace("</head>", `<style>.deck{padding:28px 0 56px}.slide{display:none!important}.slide#slide-${String(slideNumber).padStart(2, "0")}{display:block!important}</style></head>`),
  "utf8"
)));
console.log(OUT);
